...
3.    Open Python and run `import brbc-postprocessing as brbc`
4.    Run the function `brbc.generate_plot('<station_id>')`, where `<station_id>` is the 7-digit identifier used by ECCC
